...
**어떤 옵션이든 직접 선택하고, 그 결과를 측정하세요.**

- 옵션 A를 선택하면 깔끔하지만, M2에서 메타데이터 필터를 연습할 데이터가 없습니다.
- 옵션 B를 선택하면 검색 결과에 구버전이 섞이지만, M2에서 필터로 해결하는 경험을 할 수 있습니다.

결정의 근거를 EVALUATION.md에 기록하세요.
